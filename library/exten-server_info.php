<?php
/*
 * Authors:	Duncan Maina <duncan.dtech@mail.com>
*/
...
<?php
	echo "<h3 class = 'bold-header'>General Information</h3>";
?>
...
<?php
	echo "<h3 class = 'bold-header'>Memory Information</h3>";
	$meminfo = get_memory();
?>
...
<?php
	echo "<h3 class = 'bold-header'>Harddrive Information</h3>";
...
<?php
	echo "<h3 class = 'bold-header'>Network Interfaces</h3>";
